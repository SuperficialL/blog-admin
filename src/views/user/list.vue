  ...
  <div class="app-container">
    ...
    <div class="content">
      ...
      >
        ...
        <el-table-column width="140" align="center" sortable prop="username" label="昵称">
          <template slot-scope="scope">
        ...
        <el-table-column width="180" align="center" sortable prop="email" label="邮箱">
          <template slot-scope="scope">
            <span>{{ scope.row.email }}</span>
          </template>
        </el-table-column>

        <el-table-column align="center" sortable prop="created_time" label="注册时间">
          <template slot-scope="scope">
            <span>{{ scope.row.created_time | dateFormat }}</span>
          </template>
        </el-table-column>

        <el-table-column align="center" sortable prop="updated_time" label="登录时间">
          <template slot-scope="scope">
