    ...
    <el-form ref="postForm" :model="model" class="form-container" @submit.native.prevent="save">
      ...
      <div class="createPost-main-container">
        <el-row>
          <el-col :span="24">
            <el-form-item style="margin-bottom: 20px;" prop="title">
              <MDinput v-model="model.title" :maxlength="100" name="title" required>标题</MDinput>
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item style="margin-bottom: 20px;" prop="title">
              <MDinput v-model="model.summary" name="summary" required>摘要</MDinput>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="12">
            <el-form-item label-width="80px" label="发表时间:" class="postInfo-container-item">
              <el-date-picker
